  ...
  return {
    tools: [
      ...
      },
      {
        ...
        description:
          "Add a arrow between two items on a Miro board. An arrow is a line linking shapes or other objects. Supports captions, different stroke styles, and connector decorations.",
        inputSchema: {
          type: "object",
          properties: {
            boardId: {
